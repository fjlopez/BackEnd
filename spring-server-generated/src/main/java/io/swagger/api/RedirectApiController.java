...
public class RedirectApiController implements RedirectApi {
    ...
    public ResponseEntity<RedirectURL> getShortenedURL(@ApiParam(value = "Shortened URL sequence code",required=true) @PathVariable("sequence") String sequence,@ApiParam(value = "UserAgent, stats to update") @Valid @RequestParam(value = "userAgent", required = false) String userAgent) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<RedirectURL>(HttpStatus.NOT_IMPLEMENTED);
    }
